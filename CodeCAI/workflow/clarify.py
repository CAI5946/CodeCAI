...
from CodeCAI.llm_adapter import LLMAdapter, LLMAdapterError, Message
from CodeCAI.output_format import format_output_title
from CodeCAI.safety import PermissionProfile, SafetyPolicy
from CodeCAI.tools import ToolResult, ToolSpec, run_tool
from CodeCAI.tooling.file_tools import FILE_TOOLS
from CodeCAI.tooling.search_tools import SEARCH_TOOLS
from CodeCAI.tooling.web_tools import WEB_TOOLS
from CodeCAI.user_prompt import UserPromptOption, UserPromptRequest
        ...
        return [
            {
                "role": "system",
                "content": (
                    "You are the CodeCAI Workflow Clarify Agent. "
