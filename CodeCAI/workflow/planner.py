...
from CodeCAI.llm_adapter import FakeLLMAdapter, GeminiAdapter, LLMAdapter, LLMAdapterError, Message, ModelOutput
...
from CodeCAI.workflow.clarify import ClarifyResult
        ...
        return [
            {
                "role": "system",
                "content": (
                    "You are the CodeCAI Workflow Planning Agent. "
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="python -m CodeCAI.workflow.planner",
        description="Plan a CodeCAI workflow without executing the runner.",
    )
