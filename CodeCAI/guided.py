...
from CodeCAI.demand import DemandBrief, render_demand_brief
from CodeCAI.events import Event
from CodeCAI.user_prompt import UserPromptOption, UserPromptRequest
from CodeCAI.workflow.clarify import ClarifyResult, render_clarify_run
from CodeCAI.workflow.commands import run_clarify_for_session
    ...
    try:
        ...
        result = ask_user_prompt(
            UserPromptRequest(
                ...
                question="How should CodeCAI handle this DemandBrief?",
                options=(
                    UserPromptOption(
                        id="execute",
                        label="Execute",
