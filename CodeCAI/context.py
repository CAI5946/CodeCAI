"""Session-start context collection for CodeCAI."""
...
from CodeCAI.llm_adapter import Message
...
CODECAI_SYSTEM_PROMPT = """You are CodeCAI, a CLI coding agent for real software work.
...
"""
OPENCAI_SYSTEM_PROMPT = CODECAI_SYSTEM_PROMPT
...
class ContextComposer:
    system_prompt: str = CODECAI_SYSTEM_PROMPT
